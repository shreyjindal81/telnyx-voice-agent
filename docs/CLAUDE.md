...
ClawCall is an AI-powered phone agent using Deepgram Voice Agent API (STT + LLM + TTS) and Telnyx for telephony. Single-file Node.js application that makes outbound calls with an AI voice agent.
